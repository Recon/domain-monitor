 ...
 * @method     ChildUserQuery orderByRecoveryToken($order = Criteria::ASC) Order by the recovery_token column
 * @method     ChildUserQuery orderByRecoveryDate($order = Criteria::ASC) Order by the recovery_date column
 ...
 * @method     ChildUserQuery groupByRecoveryToken() Group by the recovery_token column
 * @method     ChildUserQuery groupByRecoveryDate() Group by the recovery_date column
 ...
 *
 * @method     ChildUserQuery leftJoinUsersDomain($relationAlias = null) Adds a LEFT JOIN clause to the query using the UsersDomain relation
 * @method     ChildUserQuery rightJoinUsersDomain($relationAlias = null) Adds a RIGHT JOIN clause to the query using the UsersDomain relation
 * @method     ChildUserQuery innerJoinUsersDomain($relationAlias = null) Adds a INNER JOIN clause to the query using the UsersDomain relation
 *
 * @method     ChildUserQuery joinWithUsersDomain($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the UsersDomain relation
 *
 * @method     ChildUserQuery leftJoinWithUsersDomain() Adds a LEFT JOIN clause and with to the query using the UsersDomain relation
 * @method     ChildUserQuery rightJoinWithUsersDomain() Adds a RIGHT JOIN clause and with to the query using the UsersDomain relation
 * @method     ChildUserQuery innerJoinWithUsersDomain() Adds a INNER JOIN clause and with to the query using the UsersDomain relation
 *
 * @method     \Models\AccountQuery|\Models\UsersDomainQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildUser findOneByRoles(array $roles) Return the first ChildUser filtered by the roles column
 ...
 * @method     ChildUser findOneByRecoveryToken(string $recovery_token) Return the first ChildUser filtered by the recovery_token column
 ...
 * @method     ChildUser requireOneByRecoveryToken(string $recovery_token) Return the first ChildUser filtered by the recovery_token column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildUser requireOneByRecoveryDate(string $recovery_date) Return the first ChildUser filtered by the recovery_date column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildUser[]|ObjectCollection findByRoles(array $roles) Return ChildUser objects filtered by the roles column
 ...
 * @method     ChildUser[]|ObjectCollection findByRecoveryToken(string $recovery_token) Return ChildUser objects filtered by the recovery_token column
 * @method     ChildUser[]|ObjectCollection findByRecoveryDate(string $recovery_date) Return ChildUser objects filtered by the recovery_date column
...
abstract class UserQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, account_id, username, roles, salt, email, password, recovery_token, recovery_date, created_at, updated_at FROM user WHERE id = :p0';
        try {
    ...
    public function filterByRecoveryToken($recoveryToken = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(UserTableMap::COL_RECOVERY_TOKEN, $recoveryToken, $comparison);
    }

    /**
     * Filter the query on the recovery_date column
     *
     * Example usage:
     * <code>
     * $query->filterByRecoveryDate('2011-03-14'); // WHERE recovery_date = '2011-03-14'
     * $query->filterByRecoveryDate('now'); // WHERE recovery_date = '2011-03-14'
     ...
     * @return $this|ChildUserQuery The current query, for fluid interface
     */
    public function filterByRecoveryDate($recoveryDate = null, $comparison = null)
    {
        if (is_array($recoveryDate)) {
            $useMinMax = false;
            if (isset($recoveryDate['min'])) {
                $this->addUsingAlias(UserTableMap::COL_RECOVERY_DATE, $recoveryDate['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($recoveryDate['max'])) {
                $this->addUsingAlias(UserTableMap::COL_RECOVERY_DATE, $recoveryDate['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(UserTableMap::COL_RECOVERY_DATE, $recoveryDate, $comparison);
    }
    ...
    public function filterByUsersDomain($usersDomain, $comparison = null)
    {
        if ($usersDomain instanceof \Models\UsersDomain) {
            return $this
                ->addUsingAlias(UserTableMap::COL_ID, $usersDomain->getUserId(), $comparison);
